...
<section class="main">
    <div class="container">
        ...
        <div class="text-center alm-btn-wrap">
            <button id="cate_loadmore_pc" class="alm-load-more-btn more btn-show-more-2018">Tải thêm sản phẩm <i
        ...
        <div class="z_container">
            <div class="row">
                ...
                <div class="col-xs-12 col-lg-6 col-md-6 ">
                    ...
                    <div class="statistic">
                        <div class="pull-left"><span><i class="fa fa-rss"></i>&nbsp; Đã truy câp: 613180</span>
                            <span><i class="fa fa-users"></i>&nbsp;471 Đang online</span>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div role="form" class="wpcf7" id="wpcf7-f19666-o1" lang="vi" dir="ltr">
                    ...
                    <form action="/xe-may-dien/#wpcf7-f19666-o1" method="post" class="wpcf7-form init"
