...
<head>
    ...
    <title>PHỤ TÙNG XE ĐIỆN CHÍNH HÃNG | Phụ tùng xe điện, xe máy 50cc</title>
    <link rel="stylesheet"
    ...
    <meta property="og:description"
          content="Địa chỉ nào đầy đủ nhất các loại phụ tùng xe điện? Xe điện Việt Thanh cung cấp đầy đủ các đồ phụ trợ, phụ kiện cho xe điện, xe cub, xe ga 50cc chính hãng.."/>
    ...
    <link rel="alternate" type="application/json" href="https://xedienvietthanh.com/wp-json/wp/v2/categories/1401"/>
...
<body class="archive category category-phu-tung-xe-dien category-1401 category-template-category-product-2-php"
...
<section class="main">
    <div class="container">
        <div class="title2">
            <h1 class="tit">{{$category->title}}</h1>
        ...
        <div id="result_cate_page" class="cate-items-products row">
            ...
            <!-- loop product -->
            <div class="col-xs-6 col-md-3 display-pt10 item item-special">
                <div class="col-item">
                    <div class="item-inner">
                        <div class="product-wrapper">
                            <a href="{{route('thong-tin-san-pham',$product->slug)}}" title="{{$product->name}}">
                                <!-- <div onclick="modalCateSpecial(this,8660)" class="" data-toggle="modal" data-target="#modalCateSpecial">
      </div> -->
                                <img src="{{env('APP_URL') . '/documents/website/'.$product->imagemain}}"
                                     ...
                                     loading="lazy"/> <span class="icon ico-default ">Mặc định</span> </a>
                        </div>
                        <div class="item-info">
