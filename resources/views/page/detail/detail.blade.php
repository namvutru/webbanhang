                        ...
                        <div class="col-item">
                            <div class="item-inner">
                                <div class="product-wrapper transition">
                                    <a href="https://xedienvietthanh.com/xe-ga-50cc-espero-diamond/"
                                       title="Xe ga 50cc Espero Diamond Pro">
                                        <img
                                            src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E"
                                            class="lazy lazyload transition"
                                            data-lazy-src="https://xedienvietthanh.com/wp-content/uploads/2023/05/xe-ga-50cc-espero-diamond.jpg">
                                        <noscript><img
                                                src="https://xedienvietthanh.com/wp-content/uploads/2023/05/xe-ga-50cc-espero-diamond.jpg"
                                                class="lazy lazyload transition"></noscript>
                                    </a>
                                    <span class="icon ico-default ">Mặc định</span></div>
                                <div class="item-info">
                                    <h5 class="item-title text-uppercase"><a
                                            href="https://xedienvietthanh.com/xe-ga-50cc-espero-diamond/"
                                            title="Xe ga 50cc Espero Diamond Pro">Xe ga 50cc Espero Diamond Pro</a></h5>
                                    <div class="item-price">
                                            <span class="old-price"><span
                                                    class="price">22.900.000 đ</span></span>
                                        <span class="regular-price"><span class="price">21.900.000 đ</span></span>
                                    </div>
                                </div>
                ...
                <div>
                    ...
                    <div class="item">
                        <div class="col-item">
                            <div class="item-inner">
                                <div class="product-wrapper transition">
                                    <a href="https://xedienvietthanh.com/xe-may-dien-yadea-v002-vfv/"
                                       title="Xe máy điện YADEA V002 (VFV)">
                                        <img
                                            src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%200%200'%3E%3C/svg%3E"
                                            class="lazy lazyload transition"
                                            data-lazy-src="https://xedienvietthanh.com/wp-content/uploads/2023/02/xe-dien-yadea-v002-vfv-anh-dai-dien-1.jpg">
                                        <noscript><img
                                                src="https://xedienvietthanh.com/wp-content/uploads/2023/02/xe-dien-yadea-v002-vfv-anh-dai-dien-1.jpg"
                                                class="lazy lazyload transition"></noscript>
                                    </a>
                                    <span class="icon ico-hot ">Hot</span></div>
                                <div class="item-info">
                                    <h5 class="item-title text-uppercase"><a
                                            href="https://xedienvietthanh.com/xe-may-dien-yadea-v002-vfv/"
                                            title="Xe máy điện YADEA V002 (VFV)">Xe máy điện YADEA V002 (VFV)</a></h5>
                                    <div class="item-price">
                                            <span class="old-price"><span
                                                    class="price">35.000.000 đ</span></span>
                                        <span class="regular-price"><span class="price">27.990.000 đ</span></span>
                                    </div>
                                </div>
                                <div class="item-detail">
                                    <div class="item-offers">
                                        - Quà tặng trị giá tới 500K <br/> - Áp dụng giao hàng toàn quốc<br/></div>
                                    <div class="item-link">
                                        <button data-name="Xe máy điện YADEA V002 (VFV)"
                                                data-image="https://xedienvietthanh.com/wp-content/uploads/2023/02/xe-dien-yadea-v002-vfv-anh-dai-dien-1.jpg"
                                                data-price="27990000"
                                                class="btn btn-success bk-btn-paynow-list" id="" type="button"
                                                style="width: 122px; height: 25px; margin-top: -3px; font-size: 11px">
                                            MUA NGAY
        ...
        <div class="z_container">
            <div class="row">
                ...
                <div class="col-xs-12 col-lg-6 col-md-6 ">
                    ...
                    <div class="statistic">
                        <div class="pull-left"><span><i class="fa fa-rss"></i>&nbsp; Đã truy câp: 579975</span>
                            <span><i class="fa fa-users"></i>&nbsp;481 Đang online</span>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div role="form" class="wpcf7" id="wpcf7-f19666-o1" lang="vi" dir="ltr">
                    ...
                    <form action="/xe-ga-50cc-valerio/#wpcf7-f19666-o1" method="post" class="wpcf7-form init"
